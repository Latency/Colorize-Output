  ...
  public class MenuItemTest {
    ...
    public void LaunchCommand() {
      UIThreadInvoker.Invoke((ThreadInvoker) delegate() {
        CommandID menuItemCmd = new CommandID(OpenSourceCommunity.VSPackage2.GuidList.guidVSPackage2CmdSet, (int) OpenSourceCommunity.VSPackage2.PkgCmdIDList.cmdidColorizeOutput);

        // Create the DialogBoxListener Thread.
        string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "Colorize Output", "OpenSourceCommunity.VSPackage2.VSPackage2Package");
