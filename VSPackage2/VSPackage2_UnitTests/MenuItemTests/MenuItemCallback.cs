...
using OpenSourceCommunity.VSPackage2;

namespace VSPackage2_UnitTests.MenuItemTests {
  [TestClass()]
  public class MenuItemTest {
    ...
    public void InitializeMenuCommand() {
      ...
      CommandID menuCommandID = new CommandID(OpenSourceCommunity.VSPackage2.GuidList.guidVSPackage2CmdSet, (int) OpenSourceCommunity.VSPackage2.PkgCmdIDList.cmdidColorizeOutput);
