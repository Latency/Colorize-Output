...
namespace ColorizeOutput {
  ...
  public class ColorizeOutputOptions : DialogPage {
    ...
    [Description("Specify patterns (Regular Expressions) and assoicate with classification types. " + "The order of the patterns is significant. " + "Delete all patterns to restore default patterns.")]
