// ****************************************************************************
// * Project:  Tests
// * File:     FindResultsClassifierTests.cs
// * Date:     06/18/2014
// ****************************************************************************
...
namespace Tests {
  ...
  public class FindResultsClassifierTests {
    ...
    public void Setup() {
      ...
      mockSearchTermClassification.Setup(c => c.IsOfType(OutputClassificationDefinitions.FindResultsSearchTerm)).Returns(true);

      var mockClassificationTypeRegistryService = new Mock<IClassificationTypeRegistryService>();
      mockClassificationTypeRegistryService.Setup(c => c.GetClassificationType(It.IsAny<string>())).Returns((string classificationType) => new FakeClassificationType(classificationType));
    ...
    private static string BuildFindResultsBanner(string searchTerm, bool caseSensitive = false, bool matchWord = false, bool usingRegularExpressions = false, bool usingWildcards = false, bool filenamesOnly = false,
