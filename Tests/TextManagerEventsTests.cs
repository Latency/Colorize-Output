// ****************************************************************************
// * Project:  Tests
// * File:     TextManagerEventsTests.cs
// * Date:     06/18/2014
// ****************************************************************************
  ...
  public class TextManagerEventsTests {
    ...
    public void UserPrefrencesChangedNotUpdateColorsForNotTextEditorCategory() {
      try {
        ...
        const uint flags = (uint) (__FCSTORAGEFLAGS.FCSF_LOADDEFAULTS | __FCSTORAGEFLAGS.FCSF_NOAUTOCOLORS | __FCSTORAGEFLAGS.FCSF_PROPAGATECHANGES);
    ...
    public void UserPrefrencesChangedUpdateColorsForTextEditorCategory() {
      ...
      try {
        ...
        const uint flags = (uint) (__FCSTORAGEFLAGS.FCSF_LOADDEFAULTS | __FCSTORAGEFLAGS.FCSF_PROPAGATECHANGES | __FCSTORAGEFLAGS.FCSF_NOAUTOCOLORS);
